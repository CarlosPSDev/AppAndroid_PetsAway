...
import com.dam.m21.petsaway.chat.notificationes.Data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // and this
                startActivity(new Intent(MessageActivity.this, MainActivityChat.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, R.string.mensaje_chat_vacio, Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.mipmap.ic_lanzador, username+": "+message, "Nuevo mensaje",
                            userid);
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200){
                                        if (response.body().success != 1){
                                            Toast.makeText(MessageActivity.this, R.string.msg_error_enviar_notif, Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                }
